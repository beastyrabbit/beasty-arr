...
const settingValidators = {
  ...
  aiDailyLimitEnabled: z.boolean(),
  aiMaxChecksPerDay: z.number().int().min(0).max(500),
  aiParallelism: z.number().int().min(1).max(10),
...
export const settingsSchema = z.object({
  ...
  aiDailyLimitEnabled: settingValidators.aiDailyLimitEnabled.default(true),
  aiMaxChecksPerDay: settingValidators.aiMaxChecksPerDay.default(20),
  aiParallelism: settingValidators.aiParallelism.default(5),
